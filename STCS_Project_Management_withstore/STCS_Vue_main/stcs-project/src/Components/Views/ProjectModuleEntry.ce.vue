...
@font-face {
  ...
  @media (max-width: 768px) {
    ...
    .left-login-screen-bg {
      padding: 15px !important;
    }
  
    .left-login-screen-bg::before {
  ...
  nav::before {
    ...
    top: 0px;
    right: 0px;
    background-image: url(../images/bg-nav-1.svg);
    background-repeat: no-repeat;
    z-index: -1;
  }
  ...
  nav::after {
    ...
    top: 0px;
    right: 0px;
    background-image: url(../images/bg-nav-2.svg);
    background-repeat: no-repeat;
    z-index: -1;
  }
  ...
  .bg-verify::before {
    ...
    bottom: 0px;
    left: 0px;
    background-image: url(../images/verify-image.png);
    background-repeat: no-repeat;
    z-index: 3;
  }
  ...
  .bg-login-screen-1::before {
    ...
    bottom: 0px;
    right: 0px;
    background-image: url(../images/bg-login-screen-1.svg);
    background-repeat: no-repeat;
    z-index: 1;
  }
  
  .bg-login-screen-2::before {
    width: 350px;
    height: 541px;
    content: ' ';
    position: fixed;
    bottom: 0px;
    right: 0px;
    background-image: url(../images/bg-login-screen-2.svg);
    background-repeat: no-repeat;
    z-index: 1;
  }
  ...
  #approveThePlan .modal-content::before, #requestModification .modal-content::before {
    width: 216px;
    height: 270px;
    content: ' ';
    position: absolute;
    bottom: 0px;
    left: -110px;
    background-image: url(../images/modal-approveThePlan.png);
    background-repeat: no-repeat;
    z-index: 1;
  }
  
  #proceed .modal-content::before, #modificationRequestSubmitted .modal-content::before {
    width: 216px;
    height: 270px;
    content: ' ';
    position: absolute;
    bottom: 0px;
    left: -110px;
    background-image: url(../images/modal-proceed.png);
    background-repeat: no-repeat;
    z-index: 1;
  }
  ...
  .nav-right>ul>li .badge {
    ...
    font-weight: 400;
    font-family:"STC Forward";
    background: #D8222A 0% 0% no-repeat padding-box;
  }
  ...
  .nav-right .dropdown-menu .dropdown-item:focus,
  ...
  .nav-right .dropdown-menu .dropdown-item.angle::after {
    width: 16px;
    height: 16px;
    content: ' ';
    position: absolute;
  ...
  .card.grey:hover {
    background-color: rgb(142 154 160 / 10%);
    box-shadow: none;
    border-radius: 15px;
  }
  ...
  .bg-wts::before {
    ...
    top: -70px;
    left: 0px;
    background-image: url(../images/bg-wts.svg);
    background-repeat: no-repeat;
    background-size: cover;
  }
  ...
  .nav-tabs .nav-link.active:hover {
    color: #FF375E;
    border-color: #ffffff #ffffff #FF375E;
  }
  ...
  .badge.bg-light-success {
    background-color: rgba(34, 198, 151, 0.1);
    color: #22C697 !important;
  }
  
  .badge.bg-light-orange {
    background-color: rgba(255, 116, 70, 0.1);
    color: #FF7446 !important;
  }
  
  .badge.bg-light-default {
    background-color: rgba(79, 0, 140, 0.1);
  ...
  .red-dot {
    background: #FF375E;
    box-shadow: 0px 4px 8px rgba(255, 55, 94, 0.5);
    position: absolute;
    width: 7px;
    height: 7px;
    margin-top: -4px;
  ...
  .is-invalid {
    border-bottom: 1px solid #FF375E !important;
  }
  ...
  .form-group:has(input.form-control:focus) label {
    opacity: 0.6;
  }
  ...
  .milestoneDetails input[type=checkbox] {
    accent-color: #4F008C;
    cursor: pointer;
  }
  ...
  .icon-circle {
    ...
    height: 30px;
    border-radius: 12px;
    border: 1px solid rgba(79, 0, 140, 0.20);
    background: #ffffff;
    text-align: center;
    margin: 0px 7px;
    padding: 3px;
